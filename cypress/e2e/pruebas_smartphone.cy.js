...
describe("Pruebas en diferentes navegadores para smarphone", () => {
  ...
  beforeEach(() => {
    cy.viewport(320, 568);//cambio de view port para simular tamaño de pantalla de dispositivo movil
  ...
  it("E19-E24-E29 - Verificar que el enlace entre un tag y un post sea exitosa", () => {
    //create tag
    tagsPage.createTag("Tag de prueba");
    cy.wait(2000);
    //And I create posts
    postPage.createPostMobile("Post de prueba");
    cy.wait(2000);
   ...
   it('E20-E25-E30 - Verificacion que el post en el site si tenga el tag', () => {
    //create tag
    tagsPage.createTag("Tag de prueba");
    cy.wait(2000);
    //And I create posts
